    ...
    private function getSchema($section)
    {
        $schemas = [
            'Home' => [
                ...
                'slider_1_btn_text' => ['type' => 'text', 'label' => 'Slider 1 – Button Text', 'default' => 'Cresta Plan'],
                'slider_1_btn_url' => ['type' => 'text', 'label' => 'Slider 1 – Button URL', 'default' => 'personal-budgeting-planning-system'],
                'slider_2_title' => ['type' => 'text', 'label' => 'Slider 2 – Title'],
                'slider_2_desc' => ['type' => 'textarea', 'label' => 'Slider 2 – Description'],
                'slider_2_btn_text' => ['type' => 'text', 'label' => 'Slider 2 – Button Text', 'default' => 'financePRO'],
                'slider_2_btn_url' => ['type' => 'text', 'label' => 'Slider 2 – Button URL', 'default' => 'lending-saving-system'],
                ...
                'slider_3_btn_text' => ['type' => 'text', 'label' => 'Slider 3 – Button Text', 'default' => 'BoldPos'],
                'slider_3_btn_url' => ['type' => 'text', 'label' => 'Slider 3 – Button URL', 'default' => 'point-of-sale-system'],
                ...
                'slider_4_btn_text' => ['type' => 'text', 'label' => 'Slider 4 – Button Text', 'default' => 'Hospital System'],
                'slider_4_btn_url' => ['type' => 'text', 'label' => 'Slider 4 – Button URL', 'default' => 'hospital-clinic-management-system'],
                ...
                'slider_5_btn_text' => ['type' => 'text', 'label' => 'Slider 5 – Button Text', 'default' => 'e-Learning System'],
                'slider_5_btn_url' => ['type' => 'text', 'label' => 'Slider 5 – Button URL', 'default' => 'e-learning-system'],
                'intro_title' => ['type' => 'text', 'label' => 'Intro Title (below banner)'],
                // ── Trust Cards Section ───────────────────────────────────
                'trust_card_1_text' => ['type' => 'text', 'label' => 'Trust Card 1 – Text', 'default' => 'Certified by NITA-Uganda'],
                'trust_card_2_text' => ['type' => 'text', 'label' => 'Trust Card 2 – Text', 'default' => '10+ years of experience in ICT solutions'],
                'trust_card_3_text' => ['type' => 'text', 'label' => 'Trust Card 3 – Text', 'default' => 'Trusted by Organizations, schools, hospitals, SACCOs, and businesses'],
                // ── Solutions Section ─────────────────────────────────────
                'solutions_subtitle' => ['type' => 'text', 'label' => 'Solutions Section – Subtitle', 'default' => 'OUR SOLUTIONS'],
                'solutions_title' => ['type' => 'text', 'label' => 'Solutions Section – Title', 'default' => 'Software Solutions Built For Your Business'],
                'solutions_desc' => ['type' => 'textarea', 'label' => 'Solutions Section – Description', 'default' => 'At Nugsoft Technologies, we build affordable, reliable software solutions designed for schools, clinics, shops, and businesses across East Africa. Each product is built with simplicity and power in mind — so you spend less time on admin and more time growing your business.'],
                // ── Feature Cards ─────────────────────────────────────────
                'feature_1_title' => ['type' => 'text', 'label' => 'Feature 1 Title'],
                'feature_1_desc' => ['type' => 'textarea', 'label' => 'Feature 1 Description'],
                'feature_1_link' => ['type' => 'text', 'label' => 'Feature 1 Link URL', 'default' => 'lending-saving-system'],
                'feature_2_title' => ['type' => 'text', 'label' => 'Feature 2 Title'],
                'feature_2_desc' => ['type' => 'textarea', 'label' => 'Feature 2 Description'],
                'feature_2_link' => ['type' => 'text', 'label' => 'Feature 2 Link URL', 'default' => 'point-of-sale-system'],
