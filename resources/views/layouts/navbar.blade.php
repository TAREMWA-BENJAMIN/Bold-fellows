	...
	<div class="head-wrapp">
		...
		<ul class="main-menu alternative">
			...
			<li><a href="products" title="Our Products" {!! (isset($active) && $active == 'products') ? 'id="current"' : '' !!}>Products</a>
				<!-- Second Level / Start -->
				<ul>
					<li><a href="personal-budgeting-planning-system"
							title="Personal Budgeting & planning system">Personal Budgeting & planning system</a></li>
					<li><a href="lending-saving-system" title="Lending & Saving System">Lending & Saving System</a></li>
					<li><a href="inventory-management-system" title="Inventory Management System">Inventory Management
							System</a></li>
					...
					<li><a href="payment-processing-system" title="Payment Processing System">Payment Processing
							System</a></li>
					<li><a href="hospital-clinic-management-system"
							title="Hospital/Clinic Management System">Hospital/Clinic Management System</a></li>
