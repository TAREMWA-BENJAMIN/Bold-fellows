...
<!-- Mirrored from www.cybersecurityafrica.com/advanced-ethical-hacking.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 May 2026 09:25:56 GMT -->
<head>
<meta charset="utf-8">
<title>Training | Advanced Ethical Hacking</title>
		  ...
		  <div class="container">
				<div class="one-half">
					<ul class="contact-links">
					  ...
					  <li><a href="cdn-cgi/l/email-protection#3b52555d547b5842595e49485e584e49524f425a5d4952585a15585456"><i class="icon-envelope"></i><span class="__cf_email__" data-cfemail="afc6c1c9c0efccd6cdcadddccaccdaddc6dbd6cec9ddc6ccce81ccc0c2">[email&#160;protected]</span> </a></li>
					</ul>
				</div>
				<div class="one-half">
...
<li><a href="upcoming-events" title="Upcoming Events">Upcoming Events</a></li>
		...
		<div id="content">
			<div id="breadcrumb">
				...
				<div class="container">
					<div class="one-half">
						<h4>Advanced Ethical Hacking Training</h4>
					</div>
					<div class="one-half">
						<nav id="breadcrumbs">
							...
							<div class="media-holder">
								<div class="item-wrapp">
									<div class="blog-item large">
										...
										<img src="images/blog/advanced-training.jpg" alt=""/>
									</div>
								</div>
							</div>
					  <div class="permalink">
								<h4 align="justify"><a href="penetration-testing">Advanced Ethical Hacking Training </a></h4>
							</div>
							<div align="justify">
							  <!-- End post-meta -->
					  </div>
							<div class="post-intro">
								<p align="justify">
									Our Advanced Ethical Hacking Course has proven to be the most practical course in Security. We help you realize the latest attacks that hackers are using. By learning and anticipating the hackers next move, you able to thwart these threats before they materialise. You will learn the skills that hackers, both inside and outside the organisation are using.
								</p>
                                <p align="justify">Recently big organisations such as Google, Sony and many banks and telecommunication companies across Africa have been hacked. How are the hackers breaking in past the firewalls and intrusion detection system? </p>
                                <p align="justify">The course will immerse the student into an interactive practical environment where they will be shown how to hack and secure their own systems.The lab intensive environment gives each student in-depth knowledge and practical experience with the latest essential security systems.</p>
                        ...
                        <ul class="tabs-nav">
							...
							<li>
							<a href="#tab2"><i class="icon-user"></i>Requirements</a>
							</li>
							<li>
							<a href="#tab3"><i class="icon-desktop"></i>Extra Materials</a>
							</li>
							<li>
        ...
        <li>Man in the Middele Attacks</li>
        <li>Client Side Attacks</li>
        <li>Advanced Password Cracking</li>
        <li>Defences against the above attacks</li>
      </ul>
    </li> 
							...
							<div class="tab-content" id="tab2">
                              <p>
                                ...
                                A laptop is a compulsory requirement due to the practical labs in the course. The laptop should have at least the specifications listed below:-</p>

<li>Laptop with administrative level access</li>
<li>5 GB available hard drive space</li>
<li>1 GB RAM or higher
DVD drive (minimum 12x recommended)</li>
<li>x86 compatible 2Ghz CPU minimum or higher</li>
...
In addition to the course work book and dvd , students will also get a virtual image for linux which they can be using before they fully migrate to linux. This virtual image will provide practical experience for the students. Students will also received additional notes they can use for their linux servers
								</p>
...
<strong>Email: </strong><a href="cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="aec7c0c8c1eecdd7cccbdcddcbcddbdcc7dad7cfc8dcc7cdcf80cdc1c3">[email&#160;protected]</a> 
								</p>
    ...
    <li><a href="source-code-security" title="Source Code Security"><i class="icon-angle-right"></i>Source Code Security</a></li>						
        ...
        <p> Email: <a href="cdn-cgi/l/email-protection#bfd6d1d9d0ffdcc6dddacdccdadccacdd6cbc6ded9cdd6dcde91dcd0d2"><span class="__cf_email__" data-cfemail="4c25222a230c2f352e293e3f292f393e2538352d2a3e252f2d622f2321">[email&#160;protected]</span></a></p>
		</section>
		</section>
		</footer>
