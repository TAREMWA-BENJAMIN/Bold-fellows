...
<head>
<meta charset="utf-8">
<title>Cyber Security Africa- Internet Security, Information Security, Consulting, Training, Certified Ethical Hacking, Computer Forensic, Banking</title>
<meta name="Keywords" content="Cyber Security Africa, Source code Security tool, Vulnerability Assessment, Vulnerability scan, Vulnerability tools,
...
<meta name="Description" content="We are a full-service Information Security Consulting firm offering a comprehensive range of Services and Products to help organizations protect their valuable assets. " />
...
<script type="text/javascript" src="js/isotope.min.js"></script><!--ISOTOPE JS FILE --> <!-- MAIN STYLE CSS FILE -->
...
<div id="container">
	  ...
	  <header id="header" class="header-3">
		  ...
		  <div class="container">
				<div class="one-half">
					<ul class="contact-links">
						...
						<li><a href="#"><i class="icon-home"></i>Africa Headquarter: Nairobi, Kenya </a></li>
						
						<li><a href="cdn-cgi/l/email-protection#7f161119103f1c061d1a0d0c1a1c0a0d160b061e190d161c1e511c1012"><i class="icon-envelope"></i><span class="__cf_email__" data-cfemail="e1888f878ea182988384939284829493889598808793888280cf828e8c">[email&#160;protected]</span> </a></li>
					</ul>
				</div>
				<div class="one-half">
					...
					<ul class="social-links">
						<!-- header social links starts-->
						<li><a href="https://twitter.com/cybersecafrica" class="tooltip" title="Twitter"><i class="icon-twitter"></i></a></li>
						<li><a href="#" class="tooltip" title="Facebook"><i class="icon-facebook"></i></a></li>
						<li><a href="http://www.linkedin.com/company/cyber-security-africa?trk=tyah&amp;trkInfo=tas%3Acyber+security+africa,idx%3A1-1-1" class="tooltip" title="linkedin"><i class="icon-linkedin"></i></a></li>
						<li><a href="#" class="tooltip" title="Google Plus"><i class="icon-google-plus"></i></a></li>
						<li><a href="#" class="tooltip" title="Skype"><i class="icon-skype"></i></a></li>
		...
		<div class="container">
			<div class="head-wrapp">
				<a href="index" id="logo"><img src="images/logo.png" alt="Cyber Security Africa" width="182" height="85"/><span></span></a>
				<!--your logo-->
				 <ul class="main-menu alternative">
					<li><a href="index" title="Home" id="current">Home</a>
				   ...
				   <li><a href="services" title="Our Services">Our Services</a>
					<!-- Second Level / Start -->
					<ul>
						<li><a href="penetration-testing" title="Penetration Testing">Penetration Testing</a></li>
						<li><a href="web-app-penetration-testing" title="Internet &amp; Mobile Banking Security Testing">Internet & Mobile Banking</a></li>
						<li><a href="computer-forensics-services" title="Computer Forensics">Computer Forensics</a></li>
                        <li><a href="services" title="All Services">All Services</a></li>
						
					</ul>
					<!-- Second Level / End -->
                   </li>
				   <li><a href="products" title="Our Products">Products</a>
					<!-- Second Level / Start -->
					<ul>
						<li><a href="endpointsecurity" title="Endpoint Security">Endpoint Security</a></li>
						<li><a href="vulnerabilitymanagement" title="Vulnerability Management">Vulnerability Management</a></li>
	...
	<li><a href="upcoming-events" title="Upcoming Events">Upcoming Events</a></li>
		...
		<div class="ls-layer" style="slidedirection: top; slidedelay: 6000; durationin: 1500; durationout: 1500; delayout: 500;">
		   ...
		   <img src="images/slider/layer/1/6thEthiopia.png" class="ls-s6" alt="" style="top: 10px; left: -15px; slidedirection : bottom; slideoutdirection : bottom; durationin : 1500; durationout : 750; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 600;">
            ...
            <br>         
			  ...
			  <a class="button huge color round ls-s8" href="6th-Ethiopia-Banking-ICT-Summit" style="position: absolute; top:320px; left: 490px; slidedirection : bottom; slideoutdirection : bottom; durationin : 3000; durationout : 750; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 1100;">View Event Details</a>
		  </div> 
		    ...
		    <a href="services" title="Services" class="button huge color round ls-s8" style="position: absolute; top:280px; left: 490px; slidedirection : bottom; slideoutdirection : bottom; durationin : 3000; durationout : 750; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 1100;">View Our Services</a>
		  </div>
           
		  <div class="ls-layer" style="slidedirection: right; slidedelay: 5000; durationin: 1500; durationout: 1500;">
			<img src="images/slider/layer/2/slide3-bg.jpg" class="ls-bg" alt="">
				<img src="images/slider/layer/2/item-01.png" class="ls-s6" alt="" style="top: 15px; left: 480px; slidedirection : bottom; slideoutdirection : bottom; durationin : 1500; durationout : 750; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 600;">
			<h1 class="ls-s3 ls_large_text_01" style="position: absolute; font-family:'Century Gothic', Arial, Verdana; top:100px; left: 0px; slidedirection : right; slideoutdirection : left; durationin : 3000; durationout : 750; easingin : easeInOutQuint; easingout : easeInBack; delayin : 400;">Network Management <br>and Security Training </h1>
		    <h4 class="ls-s3 l1-s1 ls_large_text_02" style="position: absolute; top:160px; left: 0px; border-color:#fff; slidedirection : bottom; slideoutdirection : left; durationin : 3000; durationout : 750; easingin : easeInOutQuint; easingout : easeInBack; delayin : 500;"></h4>
			  <a class="button huge color round ls-s8" href="training" style="position: absolute; top:210px; left: 0px; slidedirection : bottom; slideoutdirection : bottom; durationin : 3000; durationout : 750; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 0;">Training Courses</a>
			</div>
			<div class="ls-layer" style="slidedirection: right; slideoutdirection : top; slidedelay: 5000; durationin: 1500; durationout: 1500; delayout: 500;">
			  <img src="images/slider/layer/3/slide4-bg.jpg" class="ls-bg" alt="">
				<img src="images/slider/layer/3/slide3-pic1.png" class="ls-s6" alt="" style="top: 25px; left: 0px; slidedirection : fade; slideoutdirection : fade; durationin : 1500; durationout : 750; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 500;">
			  <h1 class="ls-s3 ls_large_text_01" style="position: absolute; top:120px; left: 400px; slidedirection : top; slideoutdirection : top; durationin : 3000; durationout : 750; easingin : easeInOutQuint; easingout : easeInBack; delayin : 600;">We advice, consult, install <br> and customize solutions</h1>
				<h1 class="ls-s3 l1-s1 ls_large_text_02" style="position: absolute; top:170px; left: 400px; slidedirection : bottom; slideoutdirection : bottom; durationin : 3000; durationout : 750; easingin : easeInOutQuint; easingout : easeInBack; delayin : 700;"></h1>
				<a class="button huge color round ls-s8" href="products" style="position: absolute; top:210px; left: 400px; slidedirection : bottom; slideoutdirection : bottom; durationin : 3000; durationout : 750; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 800;"> Products Overview</a>
			</div>
			<div class="ls-layer" style="slidedirection: top; slideoutdirection : top; slidedelay: 5000; durationin: 1500; durationout: 1500; delayout: 500;">
				<img src="images/slider/layer/4/slide4-bg.jpg" class="ls-bg" alt="">
				<img src="images/slider/layer/4/slider_4_man.png" class="ls-s6" alt="" style="top: 10px; left:550px; slidedirection : bottom; slideoutdirection : bottom; durationin : 1500; durationout : 750; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 300;">
			  <h1 class="ls-s3 ls_large_text_01" style="position: absolute; top:100px; left: 0px; slidedirection : top; slideoutdirection : top; durationin : 3000; durationout : 750; easingin : easeInOutQuint; easingout : easeInBack; delayin : 500;">We test across full spectrum <br> of potential vulnerability</h1>
			  <h4 class="ls-s3 l1-s1 ls_large_text_02" style="position: absolute; top:160px; left: 0px; slidedirection : bottom; slideoutdirection : bottom; durationin : 3000; durationout : 750; easingin : easeInOutQuint; easingout : easeInBack; delayin : 600;"></h4>
				<a class="button huge color round ls-s8" href="contact" style="position: absolute; top:210px; left: 0px; slidedirection : bottom; slideoutdirection : bottom; durationin : 3000; durationout : 750; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 700;">Contact Us</a>
			</div>
		</div>
		<!--layer slider ends-->
		<div id="content">
						...
						<ul class="slider" id="sliderName">
							...
							<div class="item-wrapp">
								<div class="portfolio-item">
								  ...
								  <img src="images/portfolio/why-cyber-sec-africa.jpg" alt=""/>
								</div>
								<div class="portfolio-item-title">
									<a href="about" title="Why Cyber Security Africa">Why Cyber Security Africa</a>
									<p>
										Security / Services
									</p>
								</div>
							...
							<div class="item-wrapp">
								<div class="portfolio-item">
									...
									<img src="images/portfolio/csa-services.jpg" alt=""/>
								</div>
								<div class="portfolio-item-title">
							...
							<div class="item-wrapp">
								<div class="portfolio-item">
									...
									<img src="images/portfolio/csa-products.jpg" alt=""/>
								</div>
								<div class="portfolio-item-title">
							...
							<div class="item-wrapp">
								<div class="portfolio-item">
									<a href="events" class="item-permalink"><i class="icon-link"></i></a>
									
									<img src="images/portfolio/csa-events.jpg" alt=""/>
								</div>
								<div class="portfolio-item-title">
		...
		<div class="three-fourth">
			<h4>If you’re interested in our services or products, feel free to contact us via contact form.</h4>
		</div>
		<div class="one-fourth">
		...
		<ul>
			...
			<li><a href="web-app-penetration-testing">Web Application Penetration Testing</a></li>
			<li><a href="penetration-testing">Penetration Testing</a></li>
			<li><a href="fraud-investigation-services">Fraud Investigation Services</a></li>
		</ul>
...
<script data-cfasync="false" src="cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/v8c78df7c7c0f484497ecbca7046644da1771523124516" integrity="sha512-8DS7rgIrAmghBFwoOTujcf6D9rXvH8xm8JQ1Ja01h9QX8EzXldiszufYa4IFfKdLUKTTrnSFXLDkUEOTrZQ8Qg==" data-cf-beacon='{"version":"2024.11.0","token":"713c29fa6bb7494f985e5091a518cbc7","r":1,"server_timing":{"name":{"cfCacheStatus":true,"cfEdge":true,"cfExtPri":true,"cfL4":true,"cfOrigin":true,"cfSpeedBrain":true},"location_startswith":null}}' crossorigin="anonymous"></script>
</body>

<!-- Mirrored from www.cybersecurityafrica.com/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 May 2026 09:24:35 GMT -->
</html>