...
<head>
<meta charset="utf-8">
<title>Bold Fellows- Internet Security, Information Security, Consulting, Training, Certified Ethical Hacking, Computer Forensic, Banking</title>
	...
	<div id="wrapp">
	  ...
	  <header id="header" class="header-3">
		...
		<div class="ls-layer" style="slidedirection: top; slidedelay: 6000; durationin: 1500; durationout: 1500; delayout: 500;">
				<img src="{{ asset($content['slider_1_bg']->value ?? 'images/slider/layer/1/slide1-bg.jpg') }}" class="ls-bg" alt="">
		   <img src="images/slider/layer/1/6thEthiopia.png" class="ls-s6" alt="" style="top: 10px; left: -15px; slidedirection : bottom; slideoutdirection : bottom; durationin : 1500; durationout : 750; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 600;">
            ...
            <br>         
             ...
             <div class="ls-layer" style="slidedirection: top; slidedelay: 6000; durationin: 1500; durationout: 1500; delayout: 500;">
				<img src="{{ asset($content['slider_2_bg']->value ?? 'images/slider/layer/1/slide2-bg.jpg') }}" class="ls-bg" alt="">
              ...
              <p align="left" class="ls-s3 l1-s1 ls_large_text_07" style="color: #FFF; position: absolute; top:200px; left: 490px; slidedirection : bottom; slideoutdirection : bottom; durationin : 3000; durationout : 750; easingin : easeInOutQuint; easingout : easeInBack; delayin : 1000;">{!! $content['slider_2_desc']->value ?? 'Bold Fellows provides unrivaled technical services, trusted advice <br>to its client-base,  
						...
						<ul class="slider" id="sliderName">
							...
							<div class="item-wrapp">
								<div class="portfolio-item">
								  ...
								  <img src="{{ asset($content['home_portfolio_1_img']->value ?? 'images/portfolio/why-cyber-sec-africa.jpg') }}" alt=""/>
								</div>
							...
							<div class="item-wrapp">
								<div class="portfolio-item">
									...
									<img src="{{ asset($content['home_portfolio_2_img']->value ?? 'images/portfolio/csa-services.jpg') }}" alt=""/>
								</div>
								<div class="portfolio-item-title">
							...
							<div class="item-wrapp">
								<div class="portfolio-item">
									...
									<img src="{{ asset($content['home_portfolio_3_img']->value ?? 'images/portfolio/csa-products.jpg') }}" alt=""/>
								</div>
								<div class="portfolio-item-title">
