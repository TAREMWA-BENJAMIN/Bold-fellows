		...
		<div class="ls-layer" style="slidedirection: top; slidedelay: 6000; durationin: 1500; durationout: 1500; delayout: 500;">
		   ...
		   <img src="images/slider/layer/1/6thEthiopia.png" class="ls-s6" alt="" style="top: 10px; left: -15px; slidedirection : bottom; slideoutdirection : bottom; durationin : 1500; durationout : 750; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 600;">
            ...
            <br>         
			  ...
			  <a class="button huge color round ls-s8" href="{{ $content['slider_1_btn_url']->value ?? '6th-Ethiopia-Banking-ICT-Summit' }}" style="position: absolute; top:320px; left: 490px; slidedirection : bottom; slideoutdirection : bottom; durationin : 3000; durationout : 750; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 1100;">{{ $content['slider_1_btn_text']->value ?? 'View Event Details' }}</a>
		  </div> 
		    ...
		    <a href="{{ $content['slider_2_btn_url']->value ?? 'services' }}" title="Services" class="button huge color round ls-s8" style="position: absolute; top:280px; left: 490px; slidedirection : bottom; slideoutdirection : bottom; durationin : 3000; durationout : 750; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 1100;">{{ $content['slider_2_btn_text']->value ?? 'View Our Services' }}</a>
		  </div>
           
		  <div class="ls-layer" style="slidedirection: right; slidedelay: 5000; durationin: 1500; durationout: 1500;">
			<img src="{{ asset($content['slider_3_bg']->value ?? 'images/slider/layer/2/slide3-bg.jpg') }}" class="ls-bg" alt="">
			...
			<h1 class="ls-s3 ls_large_text_01" style="position: absolute; font-family:'Century Gothic', Arial, Verdana; top:100px; left: 0px; slidedirection : right; slideoutdirection : left; durationin : 3000; durationout : 750; easingin : easeInOutQuint; easingout : easeInBack; delayin : 400;">{!! $content['slider_3_title']->value ?? 'Network Management <br>and Security Training' !!}</h1>
		    <h4 class="ls-s3 l1-s1 ls_large_text_02" style="position: absolute; top:160px; left: 0px; border-color:#fff; slidedirection : bottom; slideoutdirection : left; durationin : 3000; durationout : 750; easingin : easeInOutQuint; easingout : easeInBack; delayin : 500;"></h4>
			  <a class="button huge color round ls-s8" href="{{ $content['slider_3_btn_url']->value ?? 'training' }}" style="position: absolute; top:210px; left: 0px; slidedirection : bottom; slideoutdirection : bottom; durationin : 3000; durationout : 750; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 0;">{{ $content['slider_3_btn_text']->value ?? 'Training Courses' }}</a>
			</div>
			<div class="ls-layer" style="slidedirection: right; slideoutdirection : top; slidedelay: 5000; durationin: 1500; durationout: 1500; delayout: 500;">
			  <img src="{{ asset($content['slider_4_bg']->value ?? 'images/slider/layer/3/slide4-bg.jpg') }}" class="ls-bg" alt="">
			  ...
			  <h1 class="ls-s3 ls_large_text_01" style="position: absolute; top:120px; left: 400px; slidedirection : top; slideoutdirection : top; durationin : 3000; durationout : 750; easingin : easeInOutQuint; easingout : easeInBack; delayin : 600;">{!! $content['slider_4_title']->value ?? 'We advice, consult, install <br> and customize solutions' !!}</h1>
				...
				<a class="button huge color round ls-s8" href="{{ $content['slider_4_btn_url']->value ?? 'products' }}" style="position: absolute; top:210px; left: 400px; slidedirection : bottom; slideoutdirection : bottom; durationin : 3000; durationout : 750; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 800;">{{ $content['slider_4_btn_text']->value ?? 'Products Overview' }}</a>
			</div>
			<div class="ls-layer" style="slidedirection: top; slideoutdirection : top; slidedelay: 5000; durationin: 1500; durationout: 1500; delayout: 500;">
				<img src="{{ asset($content['slider_5_bg']->value ?? 'images/slider/layer/4/slide4-bg.jpg') }}" class="ls-bg" alt="">
			  ...
			  <h1 class="ls-s3 ls_large_text_01" style="position: absolute; top:100px; left: 0px; slidedirection : top; slideoutdirection : top; durationin : 3000; durationout : 750; easingin : easeInOutQuint; easingout : easeInBack; delayin : 500;">{!! $content['slider_5_title']->value ?? 'We test across full spectrum <br> of potential vulnerability' !!}</h1>
			  <h4 class="ls-s3 l1-s1 ls_large_text_02" style="position: absolute; top:160px; left: 0px; slidedirection : bottom; slideoutdirection : bottom; durationin : 3000; durationout : 750; easingin : easeInOutQuint; easingout : easeInBack; delayin : 600;"></h4>
				<a class="button huge color round ls-s8" href="{{ $content['slider_5_btn_url']->value ?? 'contact' }}" style="position: absolute; top:210px; left: 0px; slidedirection : bottom; slideoutdirection : bottom; durationin : 3000; durationout : 750; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 700;">{{ $content['slider_5_btn_text']->value ?? 'Contact Us' }}</a>
			</div>
		</div>
		<!--layer slider ends-->
		<div id="content">
