...
<!-- Mirrored from www.cybersecurityafrica.com/about.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 May 2026 09:25:03 GMT -->
<head>
<meta charset="utf-8">
<title>About | Cyber Security Africa</title>
		  ...
		  <div class="container">
				<div class="one-half">
					<ul class="contact-links">
						...
						<li><a href="cdn-cgi/l/email-protection#056c6b636a45667c67607776606670776c717c6463776c66642b666a68"><i class="icon-envelope"></i><span class="__cf_email__" data-cfemail="e28b8c848da2819b80879091878197908b969b8384908b8183cc818d8f">[email&#160;protected]</span> </a></li>
					</ul>
				</div>
				<div class="one-half">
			...
			<div class="head-wrapp">
				...
				<!--your logo-->
				 <ul class="main-menu alternative">
					...
					<li><a href="about" title="About Us" id="current"> About Us</a>
					<!-- Second Level / Start -->
				...
				<div class="one">
					...
					<div class="flexslider single-portfolio-item-slider bottom-margin">
						<ul class="slides round">
							<li><img src="images/slider/cyber-security.jpg" alt=" "/></li>
							<li><img src="images/slider/about-csa.jpg" alt=" "/></li>
							<li><img src="images/slider/about-csa-1.jpg" alt=" "/></li>
						</ul>
					</div>
...
<ul class="bar_graph">
							...
							<li>
							<p>
								<i class="icon-pencil"></i>Penetration Testing</p>
							<div class="bar-wrap">
							...
							<li>
							<p>
								<i class="icon-cog"></i>Security Solutions</p>
							<div class="bar-wrap">
  ...
  <li>
							<p>
								<i class="icon-magic"></i>Security Training</p>
							<div class="bar-wrap">
...
<!-- Mirrored from www.cybersecurityafrica.com/about.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 May 2026 09:25:04 GMT -->
</html>
