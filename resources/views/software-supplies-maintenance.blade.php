						...
						<div class="one-fourth sidebar right">
							<div class="widget">
								...
								<ul class="sidebar-nav">
									...
									<li class="active"><a href="software-supplies-maintenance" title="Software Supplies &amp; Maintenance"><i class="icon-angle-right"></i>Software Supplies &amp; Maintenance</a></li>
